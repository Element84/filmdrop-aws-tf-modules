...
module "builtin_functions" {
  ...
  cirrus_workflow_metrics_log_group_name           = var.workflow_metrics_cloudwatch_enabled ? module.metrics[0].cirrus_workflow_metrics_log_group_name : ""
  cirrus_workflow_metrics_namespace                = var.workflow_metrics_cloudwatch_enabled ? module.metrics[0].cirrus_workflow_metrics_namespace : ""
  cirrus_workflow_metrics_write_policy_arn         = var.workflow_metrics_cloudwatch_enabled ? module.metrics[0].cirrus_workflow_metrics_write_policy_arn : ""
  cirrus_workflow_metrics_read_policy_arn          = var.workflow_metrics_cloudwatch_enabled ? module.metrics[0].cirrus_workflow_metrics_read_policy_arn : ""
