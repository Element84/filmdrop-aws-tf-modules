module "cirrus_api" {
  ...
  cirrus_api_rest_type               = var.cirrus_api_lambda.api_gateway_rest_type
  cirrus_api_lambda_timeout          = var.cirrus_api_lambda.timeout
  cirrus_api_lambda_memory           = var.cirrus_api_lambda.memory
  cirrus_api_provisioned_concurrency = var.cirrus_api_lambda.provisioned_concurrency
