...
Your Lambda code should, in general, receive trigger events, proccess as needed, and send them to the Cirrus Process Queue in the form of a Cirrus Process Payload [cirrus-geo.github.io/cirrus-geo/stable/cirrus/30_payload.html](https://cirrus-geo.github.io/cirrus-geo/stable/cirrus/30_payload.html). `CIRRUS_PROCESS_QUEUE_URL` is available as an environment variable for convenience.
