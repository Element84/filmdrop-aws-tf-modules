resource "aws_iam_role" "titiler_lambda_role" {
  name = "titiler-${var.titiler_stage}-${data.aws_region.current.name}-lambdaRole"
...
resource "aws_iam_policy" "titiler_lambda_policy" {
  name         = "titiler-${var.titiler_stage}-${data.aws_region.current.name}-lambdaPolicy"
...
resource "aws_iam_role" "titiler_gw_role" {
  name = "titiler-${var.titiler_stage}-${data.aws_region.current.name}-apigwRole"
...
resource "aws_iam_policy" "titiler_gw_policy" {
  name         = "titiler-${var.titiler_stage}-${data.aws_region.current.name}-apigwPolicy"
