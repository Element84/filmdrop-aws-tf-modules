...
def lambda_handler(event, context):
    try:
        ...
        try:
            ...
            origin_value = ssm.get_parameter(Name=SSM_ORIGIN_PARAM)['Parameter']['Value']
            ...
            for origin in distribution_config["DistributionConfig"]["Origins"]["Items"]:
                if "CustomHeaders" in origin.keys() and "Quantity" in origin["CustomHeaders"].keys() and origin["CustomHeaders"]["Quantity"] > 0:
                    distribution_config["DistributionConfig"]["Origins"]["Items"][origin_number]["DomainName"] = origin_value
