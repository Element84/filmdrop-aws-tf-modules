...
variable stac_server_inputs {
  ...
  type        = object({
    ...
    ingest                                        = object({
        ...
        destination_collections_min_lat           = string
        destination_collections_min_long          = string
        destination_collections_max_lat           = string
        destination_collections_max_long          = string
        date_start                                = string
        date_end                                  = string
