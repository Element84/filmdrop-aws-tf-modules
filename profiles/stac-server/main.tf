...
module "historical_ingest" {
  ...
  source = "git::https://github.com/Element84/terraform-aws-stac-server.git//modules/historical-ingest?ref=v1.0.1"
...
module "ongoing_ingest" {
  ...
  source                           = "git::https://github.com/Element84/terraform-aws-stac-server.git//modules/ongoing-ingest?ref=v1.0.1"
