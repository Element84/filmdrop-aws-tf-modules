module "cirrus" {
  ...
  cirrus_feeder_definitions_dir                             = var.cirrus_inputs.feeder_definitions_dir
  cirrus_feeder_definitions_variables                       = var.cirrus_inputs.feeder_definitions_variables
  cirrus_feeder_definitions_variables_ssm                   = var.cirrus_inputs.feeder_definitions_variables_ssm
