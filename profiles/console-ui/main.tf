module "console-ui" {
  ...
  console_ui_bucket_name  = var.console_ui_inputs.custom_content_bucket.create_content_website == false ? var.console_ui_inputs.custom_content_bucket.content_website_bucket_name : var.console_ui_inputs.deploy_cloudfront ? module.cloudfront_s3_website[0].content_bucket_name : module.content_website[0].content_bucket
...
module "cloudfront_s3_website" {
  ...
  domain_name                  = var.console_ui_inputs.custom_content_bucket.create_content_website == false ? var.console_ui_inputs.custom_content_bucket.content_bucket_regional_domain_name : ""
...
module "content_website" {
  count  = var.console_ui_inputs.custom_content_bucket.create_content_website == true && var.console_ui_inputs.deploy_cloudfront == false ? 1 : 0
