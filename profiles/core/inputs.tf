...
variable "titiler_inputs" {
  ...
  type = object({
    ...
    web_acl_id                                = string
    mosaic_titiler_provisioned_concurrency    = optional(number)
...
variable "filmdrop_ui_inputs" {
  ...
  default = {
    ...
    version                 = "v5.3.0"
    filmdrop_ui_config_file = "../filmdrop-ui/default-config/config.dev.json"
    filmdrop_ui_logo_file   = "../filmdrop-ui/default-config/logo.png"
