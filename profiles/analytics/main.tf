...
module "cloudfront_load_balancer_endpoint" {
  ...
  project_name                 = var.project_name
  environment                  = var.environment
  cf_function_name             = var.analytics_inputs.cf_function_name
  cf_function_runtime          = var.analytics_inputs.cf_function_runtime
  cf_function_code_path        = var.analytics_inputs.cf_function_code_path
  attach_cf_function           = var.analytics_inputs.attach_cf_function
